 ...
 * @export
 */
export const StreetApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiStreetIdGet: async (
      id: number,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("apiStreetIdGet", "id", id);
      const localVarPath = `/api/street/{id}`.replace(
        `{${"id"}}`,
     ...
     */
    apiStreetPost: async (
      createStreetRequestDto?: CreateStreetRequestDto,
      options: RawAxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/street`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const StreetApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiStreetGet(
        streetName,
        streetType,
        sortBy,
        isDecsending,
      ...
      const localVarOperationServerBasePath =
        operationServerMap["StreetApi.apiStreetGet"]?.[
     ...
     * @throws {RequiredError}
     */
    async apiStreetIdGet(
      id: number,
      options?: RawAxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiStreetIdGet(
        id,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StreetApi.apiStreetIdGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async apiStreetPost(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiStreetPost(
        createStreetRequestDto,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StreetApi.apiStreetPost"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const StreetApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    apiStreetPost(
      ...
      return localVarFp
        .apiStreetPost(createStreetRequestDto, options)
        .then((request) => request(axios, basePath));
    }
  };
};
...
export class StreetApi extends BaseAPI {
  ...
  public apiStreetGet(
    ...
    return StreetApiFp(this.configuration)
      .apiStreetGet(
        streetName,
        streetType,
        sortBy,
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiWeatherForecastGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["WeatherForecastApi.apiWeatherForecastGet"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
